...
//   return (
//     <div className="bg-gray-1000 fixed top-0 w-full h-14">
//       <div className="flex justify-end mr-10 mt-4 text-white">
//         <div className='mr-1'>
//           <p>Olá,</p>
//         </div>
//         <div className='mr-3'>
...
export default function Header(props:any) {
  ...
  return (
    <div className={`bg-gray-1000 fixed top-0 w-full h-14 ${isSidebarOpen ? 'sidebar-open' : ''}`}>
